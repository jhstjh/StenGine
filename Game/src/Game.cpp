...
void Game::GameInit()
{
	...
	m_gameObjectManager->Add(sphere);
	...
	m_gameObjectManager->Add(zombie);
	...
	m_gameObjectManager->Add(plane0);
	...
	m_gameObjectManager->Add(plane1);
	...
	m_gameObjectManager->Add(plants0);
	...
	m_gameObjectManager->Add(house0);
	...
	m_gameObjectManager->Add(dragon);
	...
	m_gameObjectManager->Add(terrain);
#endif
}
