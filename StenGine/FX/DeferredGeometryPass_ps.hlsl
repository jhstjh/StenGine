...
PixelOut main(VertexOut pin)
{
	...
	pout.diffuseH = ((1 - gDiffX_NormY_ShadZ.x) * gCubeMap.SampleLevel(gDiffuseMapSampler, refRay, 7) + gDiffX_NormY_ShadZ.x * gDiffuseMap.Sample(gDiffuseMapSampler, pin.TexUV)) * gMaterial.diffuse;
