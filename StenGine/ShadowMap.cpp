...
void ShadowMap::RenderShadowMap() {
	...
	for (int iMesh = 0; iMesh < EffectsManager::Instance()->m_effects[0]->m_associatedMeshes.size(); iMesh++) {
		EffectsManager::Instance()->m_effects[0]->m_associatedMeshes[iMesh]->DrawOnShadowMap();
	}
